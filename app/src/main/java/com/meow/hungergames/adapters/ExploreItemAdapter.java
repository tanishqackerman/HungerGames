...
public class ExploreItemAdapter extends RecyclerView.Adapter<ExploreItemViewHolder> {

    private ArrayList<RecipePost> recipePosts;
    private Context context;
    private ItemClickListener itemClickListener;

    public ExploreItemAdapter(Context context, ArrayList<RecipePost> recipePosts, ItemClickListener itemClickListener) {
